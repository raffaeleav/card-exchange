...
/**
 * La classe permette l'indirizzamento verso la pagina di vendita
 * @author Salvatore
 */


@WebServlet(name = "mostraPaginaVenditaServlet", value = "/mostraPaginaVenditaServlet")
public class mostraPaginaVenditaServlet extends HttpServlet {
    /**
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(utente == null)
            ...
            address ="/WEB-INF/results/vendita.jsp";
